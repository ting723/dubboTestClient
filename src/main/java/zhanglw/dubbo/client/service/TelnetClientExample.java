            ...
            try
            {
                ...
                do
                {
                    try
                    {
                        ...
                        if(ret_read > 0)
                        {
                            final String line = new String(buff, 0, ret_read,java.nio.charset.Charset.forName("UTF-8")); // deliberate use of default charset
    ...
    public void run()
    {
        ...
        try
        {
            ...
            do
            {
                ...
                if(ret_read > 0)
                {
                    System.out.print(new String(buff, 0, ret_read,java.nio.charset.Charset.forName("UTF-8")));
                }
            }
            while (ret_read >= 0);
        }
